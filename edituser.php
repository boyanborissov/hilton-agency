    ...
    <div class="container my-5 pt-4">
       ...
       <form method="get" action="editUserProcess.php">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6"> 
                <input type="text" class="form-control text-light bg-dark-gray border-0" name="username" value="<?php echo $_SESSION["editUserName"]?>">
            </div>
          </div>
          <!--Username Input-->
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control text-light bg-dark-gray border-0" name="email" value="<?php echo $_SESSION["editEmail"]?>">
            </div>
          </div>
          <!--Email Input-->
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control text-light text-light bg-dark-gray border-0" name="password" value="<?php echo $_SESSION["editPassword"]?>">
            </div>
          </div>
          <!--Password Input-->
