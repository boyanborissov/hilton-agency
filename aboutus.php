    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="5000">
        ...
        <div class="carousel-caption">
          <h5 class="text-center fs-1">Your dream home</h5>
          <p class="text-center fs-3">Find your dream home that fit with your style.</p>
        </div>
      </div>
...
<section id="about">
  ...
  <div id="about-2" class="container">
    <div class="row">
    <div class="col-md-12">
      <p class="fs-5">Founded in 1993 by owner Rick Hilton , Hilton Agency has remained privately-held, steadfastly independent, and unfettered by investors or outside shareholders for 30 years. With our sole office in Beverly Hills, we are perhaps the top-producing boutique brokerage in the world.</p>
